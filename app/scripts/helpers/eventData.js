...
define([
    ...
    var eventData = {
    	...
    	'17387c82-756d-4571-b611-3380f33eeee4' : ['map', ['germany', 'denmark', 'france', 'poland', 'austria', 'hungary', 'czech', 'slovakia']], // What Does It Mean?!
        // --------------------
        ...
        // --------------------
        // alliances 1879 - 1914
        '1d3ea481-5437-41ea-ab3c-c11f49e4756a' : ['gallery', ['italy', 'austria', 'germany', 'turkey', 'bulgaria', 'serbia', 'russia', 'france', 'uk']], //title: Friends or Foes?, id: 1d3ea481-5437-41ea-ab3c-c11f49e4756a
        ...
        '16e36221-60a0-4006-9d10-9e63dc1cf131' : ['gallery', ['uk','france']], // title: The Mansion House Speech, id: 16e36221-60a0-4006-9d10-9e63dc1cf131
        '12c6d6fd-3c66-4d41-b2bd-9995d6a1fe86' : ['gallery', ['germany', 'morocco', 'france']], // title: Popular Responses, id: 12c6d6fd-3c66-4d41-b2bd-9995d6a1fe86
        '8948dfce-7311-4455-bf45-8a066052013b' : ['gallery', ['germany', 'morocco', 'france']],  // title: July, 1911, id: 8948dfce-7311-4455-bf45-8a066052013b

        // --------------------

        // --------------------
        // Balkan war
        '99cbd580-3c22-4f5e-9fc2-b9de4f02c460' : ['map', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey']], // title: So, What's the Problem?, id: 99cbd580-3c22-4f5e-9fc2-b9de4f02c460
        'f0529e6a-5f21-4167-b68c-eddc00018a1f' : ['map', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey']],  // title: The First Balkan War, id: f0529e6a-5f21-4167-b68c-eddc00018a1f
        'ded7d0b0-1e31-45bf-b35c-f7d3ecdeb467' : ['gallery', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey']],// title: The Second Balkan War 1913, id: ded7d0b0-1e31-45bf-b35c-f7d3ecdeb467
        '4ff76a8b-1adf-497b-b92b-b2130b292996' : ['map', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey', 'austria', 'hungary', 'czech', 'slovakia', 'russia']],  // title: Annexation of Bosnia-Herzegovina by Austria-Hungary in 1908, id: 4ff76a8b-1adf-497b-b92b-b2130b292996
        '97b68113-8600-4cb8-98fc-22d0d672220d' : ['galley', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey', 'austria', 'hungary', 'czech', 'slovakia', 'russia']],// title: Wrestling for Control of the Balkans, id: 97b68113-8600-4cb8-98fc-22d0d672220d
        'cb6f7c06-9691-44af-a3ac-8115176a23b1' : ['gallery', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey', 'austria', 'hungary', 'czech', 'slovakia', 'russia']],// title: The First Balkan War -- A Closer Look, id: cb6f7c06-9691-44af-a3ac-8115176a23b1
        '43f7ac1b-1ef1-4ba2-8e4e-f4ffd17cbfb3' : ['map', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey']],// title: Ethnic Importance in the Balkans, id: 43f7ac1b-1ef1-4ba2-8e4e-f4ffd17cbfb3
        '972af7ee-2e2b-45ab-bfd5-63b6d2591489' : ['gallery', ['germany']],// title: The Balkans, id: 972af7ee-2e2b-45ab-bfd5-63b6d2591489
        '8006ad17-6972-4231-af5c-5a8baf670746' : ['map', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey', 'austria', 'hungary', 'czech', 'slovakia']],// title: So...what's the outcome?!, id: 8006ad17-6972-4231-af5c-5a8baf670746

        // --------------------

        // --------------------
        // Assassination to Outbreak of War
        '7784cfc3-5cd4-43d5-a2fd-91232c124eab' : ['gallery', ['austria', 'hungary', 'czech', 'slovakia']],//title: The Archduke, id: 7784cfc3-5cd4-43d5-a2fd-91232c124eab exhibitCollection.js:26
        '58da42c6-620f-4bf4-b31c-1b53ff0995a1' : ['gallery', ['austria', 'hungary', 'czech', 'slovakia']], // title: His Family, id: 58da42c6-620f-4bf4-b31c-1b53ff0995a1 exhibitCollection.js:26
        ...
        '4409f534-15b8-4598-be37-8b11d58b4a51' : ['gallery', ['austria', 'hungary', 'czech', 'slovakia', 'bosnia', 'turkey']], //title: Setting the Scene, id: 4409f534-15b8-4598-be37-8b11d58b4a51 exhibitCollection.js:26
        ...
        // --------------------
        'e674975e-3f15-4c61-b716-21ea9bb32107' : ['gallery', ['austria', 'hungary', 'czech', 'slovakia', 'germany', 'serbia', 'russia']],// title: Germany, id: e674975e-3f15-4c61-b716-21ea9bb32107 exhibitCollection.js:26
        '941f8509-10ba-46e2-be4d-34c3efd4fd37' : ['gallery', ['austria', 'hungary', 'czech', 'slovakia', 'serbia']],// title: Austria-Hungary, id: 941f8509-10ba-46e2-be4d-34c3efd4fd37 exhibitCollection.js:26
        '7bfac254-323a-4c5e-a13c-1abe6bec4fdc' : ['gallery', ['uk', 'serbia', 'france', 'austria', 'hungary', 'czech', 'slovakia']], // title: Reactions, id: 7bfac254-323a-4c5e-a13c-1abe6bec4fdc exhibitCollection.js:26
        'ab36d007-98ee-4ef3-9d2a-fdc169654bba' : ['map', ['austria', 'hungary', 'czech', 'slovakia', 'serbia']], // title: First assassination...now what?, id: ab36d007-98ee-4ef3-9d2a-fdc169654bba exhibitCollection.js:26
        '9073b91e-4475-4368-b9aa-8653dde0411a' : ['gallery', ['albania', 'bosnia', 'bulgaria', 'croatia', 'greece', 'kosovo', 'macedonia', 'montenegro', 'romania', 'serbia', 'turkey']],// title: War?, id: 9073b91e-4475-4368-b9aa-8653dde0411a exhibitCollection.js:26
        '28c871a2-f9ba-4ff2-ad15-9564a28d865b' : ['gallery', ['austria', 'hungary', 'czech', 'slovakia']],// title: Austria-Hungary Ultimatum to Serbia, id: 28c871a2-f9ba-4ff2-ad15-9564a28d865b exhibitCollection.js:26
        'a901e037-d777-4ab2-8a00-96dfb012861f' : ['gallery', ['austria', 'hungary', 'czech', 'slovakia', 'serbia']]// title: Options?, id: a901e037-d777-4ab2-8a00-96dfb012861f
